...
def streamlit_config():
    ...
    # page configuration
    page_icon_url = 'D:\Airbnb-Analysis-main\airbnb_logo.png'
...
class data_collection:
    akku = pymongo.MongoClient("mongodb+srv://root:root@cluster3.8gtokyk.mongodb.net/?retryWrites=true&w=majority")
    db = akku['sample_airbnb']
...
with st.sidebar:
    image_url = 'D:\Airbnb-Analysis-main\airbnb_banner.png'
